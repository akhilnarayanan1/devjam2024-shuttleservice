...
<script setup lang="ts">
  ...
  import { sendEmailVerification, createUserWithEmailAndPassword, type User } from "firebase/auth";
  ...
  const createAccount = async () => {
    ...
    loading.signup = true;
    createUserWithEmailAndPassword(auth, form.signup_email, form.signup_password)
